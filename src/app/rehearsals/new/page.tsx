...
export default function NewRehearsalPage() {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-8 pb-24 sm:pb-8">
      <Link href="/rehearsals" className="flex items-center gap-2 text-zinc-400 hover:text-white mb-6 transition-colors">
        <ArrowLeft size={16} />
        Retour
      </Link>

      <h1 className="text-2xl font-bold text-white mb-6">Proposer une répétition</h1>
